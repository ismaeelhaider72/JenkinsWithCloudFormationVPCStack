...
stage ('Release') {
      steps {
                script {
                    ...
                    if (apply) {
                            try {
                                    sh "aws cloudformation continue-update-rollback --stack-name ismaeelawsclitest2 --resources-to-skip ismaeelawsclitest2-DatabaseBstack-1OGQRJCIV4KU/d8a491b0-f4f9-11eb-a4a9-1266a0dd9289 "
