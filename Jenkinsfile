...
pipeline {
    ...
    stages {
        ...
        // stage('Show Files') {
        //     environment {
        //       MY_FILES = sh(USERPASSscript: 'cd mydir && ls -l', returnStdout: true)
        //     }
        //     steps {
        //       sh '''
        //         echo "$MY_FILES"
